...
def create_cluster():
    ...
    # 集群添加节点
    post({"nodeId": 2, "endpoint": "127.0.0.1:9091"}, "http://localhost:8080/admin/addFollower")
    print("raft has been created")
    master_server = run_master_server()
    print("master_server node has started")
    # 添加集群元数据
    post({"instanceId": "instance1", "nodeId": "node1", "url": "http://127.0.0.1:8080", "role": 0, "status": 0}, "http://localhost:6060/addNode")
    post({"instanceId": "instance1", "nodeId": "node2", "url": "http://127.0.0.1:9090", "role": 1, "status": 0}, "http://localhost:6060/addNode")
    # 查看所有节点信息
